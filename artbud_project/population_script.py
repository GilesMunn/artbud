...
def populate():
	...
	drawings_images = [
		...
		{'name': 'ClintEastwood','user': 'x-Harry-x', 'picture': 'static/images/drawings/clint.jpg', 'price': '£345', 'comment': 'Clint Eastwood portrait', 'category': 'Drawing'},
	...
	paintings_images = [
		...
		{'name': 'PersistenceofMemory','user': 'LeoFitz', 'picture': 'static/images/paintings/memory.jpg', 'price': '£22', 'comment': 'Salvador Dali painting', 'category': 'Painting'},
		{'name': 'GirlWithPearlEarrings','user': 'AgntSimm', 'picture': 'static/images/paintings/pearl_earring.jpg', 'price': '£47', 'comment': 'A pretty girl', 'category': 'Painting'},
	...
	sculpture_images = [
		...
		{'name': "MichaelangeloDavid",'user': 'RoseT2005', 'picture': 'static/images/sculpture/david.jpg', 'price': '£324', 'comment': 'The most famous statue', 'category': 'Sculpture'},
	...
	other_images = [
		...
		{'name': 'Waterfall','user': 'NameTooLo', 'picture': 'static/images/other/waterfall.jpg', 'price': '£678','comment': 'Strange 3D drawing', 'category': 'Other' } ]
